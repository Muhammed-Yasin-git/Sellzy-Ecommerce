...
exports.userHome = async (req, res) => {
  try {
    ...
    if (userEmail) {
      ...
      res.render("user_home", { products, users: userData, searchQuery, catFilter, categories: catData });
    } else {
      req.session.isBlock = false;
      req.session.isValidate = false;
      res.render("user_home", { products, users: null, searchQuery, catFilter, categories: catData });
    }
  } catch (error) {
