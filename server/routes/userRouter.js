...
router.get('/checkout-page',middlewares.userCheckMiddleware,userController.checkOut)
...
router.get('/cancel-order',middlewares.userCheckMiddleware,userServices.cancelOrder)
router.post('/cancel-reason',orderController.cancel)
router.get('/api/reason',middlewares.userCheckMiddleware,userServices.cancelReason)
router.get('/return-order',middlewares.userCheckMiddleware,userServices.returnOrder)
router.get('/api/return/reason',middlewares.userCheckMiddleware,userServices.returnReason)
router.post('/return-reason',orderController.return)

router.get('/order-details',middlewares.userCheckMiddleware,userServices.orderdetails)
router.get('/order-success',middlewares.userCheckMiddleware,userServices.orderSuccess)
